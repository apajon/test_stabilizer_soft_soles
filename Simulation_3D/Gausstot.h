...
class GaussSeidel {
    public:
      ...
      //void display();
      void set_data_output(double *displ_out,double *angleact_out,double *FtotZMPOut,double *Fc_mc3_out,double *Pc_mc3_out,double *ind_cont_out,double *Kcart_out,double *J_out);
