...
%%
%foot 1 and 2 borders, used in SSP
...
%foot 1 and 2 borders, used in DSP
xv2_reduced = [wpg_param.step_number_pankle_fixed(2,2)+(wpg_param.fronttoankle-wpg_param.sole_margin);...
        wpg_param.step_number_pankle_fixed(2,2)+(wpg_param.fronttoankle-wpg_param.sole_margin); ...
        wpg_param.step_number_pankle_fixed(2,2)-(wpg_param.backtoankle-wpg_param.sole_margin);...
        wpg_param.step_number_pankle_fixed(2,2)-(wpg_param.backtoankle-wpg_param.sole_margin); ...
        ];
yv2_reduced = [wpg_param.step_number_pankle_fixed(2,3);...
        wpg_param.step_number_pankle_fixed(2,3)+(wpg_param.exttoankle-wpg_param.sole_margin); ...
        wpg_param.step_number_pankle_fixed(2,3)+(wpg_param.exttoankle-wpg_param.sole_margin);...
        wpg_param.step_number_pankle_fixed(2,3); ...
        ];
% xv2_reduced = [xv2_reduced ; xv2_reduced(1)]; yv2_reduced = [yv2_reduced ; yv2_reduced(1)];

xv1_reduced = [wpg_param.step_number_pankle_fixed(1,2)-(wpg_param.backtoankle-wpg_param.sole_margin); ...
        wpg_param.step_number_pankle_fixed(1,2)-(wpg_param.backtoankle-wpg_param.sole_margin);...
        wpg_param.step_number_pankle_fixed(1,2)+(wpg_param.fronttoankle-wpg_param.sole_margin); ...
        wpg_param.step_number_pankle_fixed(1,2)+(wpg_param.fronttoankle-wpg_param.sole_margin);...
        ];
yv1_reduced = [wpg_param.step_number_pankle_fixed(1,3); ...
        wpg_param.step_number_pankle_fixed(1,3)-(wpg_param.exttoankle-wpg_param.sole_margin);...
        wpg_param.step_number_pankle_fixed(1,3)-(wpg_param.exttoankle-wpg_param.sole_margin); ...
        wpg_param.step_number_pankle_fixed(1,3);...
        ];
% xv1_reduced = [xv1_reduced ; xv1_reduced(1)]; yv1_reduced = [yv1_reduced ; yv1_reduced(1)];

% xv=[xv1_reduced(1:end-1);xv2_reduced(1:end-1)];
% yv=[yv1_reduced(1:end-1);yv2_reduced(1:end-1)];
xv=[xv1_reduced;xv2_reduced];
yv=[yv1_reduced;yv2_reduced];
...
%     displangleact1=[displ_tot1(:,end);angleact_tot1(:,end)]-Jmat.step_1.J_tot((40)*6+1:(40)*6+6,:)^-1*delta_F1*(1/f*1/0.05);
    displangleact1=[toto4(end,:)';toto3(end,:)']-Jmat.step_1.J_tot((40)*6+1:(40)*6+6,:)^-1*delta_F1*(1/f*1/0.05);
...
%     displangleact2=[displ_tot2(:,end);angleact_tot2(:,end)]-Jmat.step_2.J_tot((40)*6+1:(40)*6+6,:)^-1*delta_F2*(1/f*1/0.05);
    displangleact2=[toto6(end,:)';toto5(end,:)']-Jmat.step_2.J_tot((40)*6+1:(40)*6+6,:)^-1*delta_F2*(1/f*1/0.05);
