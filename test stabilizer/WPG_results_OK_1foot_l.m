...
angleact1 = Jmat.step_2.angleact_tot(:,1);
displ1 = Jmat.step_2.displ_tot(:,1);
...
%     end
    displangleact1=[displ_tot1(:,end);angleact_tot1(:,end)]-Jmat.step_2.J_tot((40)*6+1:(40)*6+6,:)^-1*delta_F1;
